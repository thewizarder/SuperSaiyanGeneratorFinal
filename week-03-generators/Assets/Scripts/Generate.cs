...
public class Generate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Picking a random hair color
        int randHairColor = Random.Range(0, hairColors.Length);
        //hair.GetComponent<Renderer>().material.shader = hairColors[randHairColor];
        ...
        //if(!eyeLeft.GetComponent<SpriteRenderer>().flipX)
        eyeLeft.GetComponent<SpriteRenderer>().flipX = true;
        ...
        //flipping the right eye
        //eyeRight.GetComponent<SpriteRenderer>().flipX = true;
        ...
        //Now to do the nose.
        Transform noseToSpawn = nosePrefabs[Random.Range(0, nosePrefabs.Length)];
        Transform nose = Instantiate(noseToSpawn);
        nose.SetParent(nosePoint);
        nose.localPosition = Vector3.zero;
        ...
        // Rotating the nose 10% of the time
        if (Random.value < 0.10f)
        {
            nose.localEulerAngles = new Vector3(0, 0, Random.Range(-10f, 10f));
        }
